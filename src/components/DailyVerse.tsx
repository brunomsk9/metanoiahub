    ...
    <section className="verse-card">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-primary uppercase tracking-wider">Versículo do Dia</span>
        </div>
      ...
      <blockquote className="space-y-4">
        <p className="font-serif text-xl leading-relaxed text-foreground/90 italic">
          "{verse.text}"
        </p>
        <footer className="text-sm font-semibold text-primary/80">
          — {verse.reference}
        </footer>
      </blockquote>
    </section>
