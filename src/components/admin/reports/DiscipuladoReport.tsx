        ...
        {[
          {
            ...
            subtitle: "relacionamentos em andamento",
            Icon: Heart,
          ...
          {
            title: "Duração Média",
            value: `${stats?.avgDuration || 0} dias`,
          ...
          },
          {
            ...
            value: `${stats && (stats.totalActive + stats.totalCompleted) > 0
              ? Math.round((stats.totalCompleted / (stats.totalActive + stats.totalCompleted)) * 100)
              : 0}%`,
            subtitle: "discipulados finalizados",
            Icon: Users,
            iconClass: "text-muted-foreground"
          }
        ].map((card, i) => (
            ...
            <CardContent>
              <ChartContainer config={chartConfig} className="h-[280px]">
                <BarChart data={monthlyProgress}>
                  ...
                  <ChartTooltip content={<ChartTooltipContent />} />
                  <Bar dataKey="novos" name="Novos" fill={CHART_COLORS.lime} radius={4} />
                  <Bar dataKey="concluidos" name="Concluídos" fill={CHART_COLORS.teal} radius={4} />
                </BarChart>
              </ChartContainer>
            </CardContent>
          </Card>
